...
# https://github.com/inspire-group/membership-inference-evaluation/blob/master/membership_inference_attacks.py
...
class black_box_benchmarks(object):
    ...
    def _mem_inf_benchmarks(self, all_methods=True, benchmark_methods=[]):
        ...
        if (all_methods) or ('modified entropy' in benchmark_methods):
            return self._mem_inf_thre('modified entropy', -self.s_tr_m_entr, -self.s_te_m_entr, -self.t_tr_m_entr,
                                      -self.t_te_m_entr)
